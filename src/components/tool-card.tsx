  ...
  return (
    <div
      className={cn(
        ...
        isOpenable ? "border-brand-primary" : isPlanned ? "border-dashed border-line" : "border-line",
    ...
    >
      ...
      <div className={cn("font-serif text-[17px] font-bold", isOpenable ? "text-ink-900" : "text-ink-700")}>
        {tool.name}
      </div>
