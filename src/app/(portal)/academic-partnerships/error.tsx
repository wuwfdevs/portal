...
/**
 * Catches read failures thrown by lib/academic-partnerships/queries.ts. A
 * broken query says so, out loud, instead of rendering as an empty pipeline —
 * see CLAUDE.md on why a swallowed Supabase error is a bug, not a fallback.
 */
export default function AcademicPartnershipsError({
  error,
  reset,
}: {
