...
/**
 * Catches read failures thrown by lib/roadmap/queries.ts. A broken query says
 * so, out loud, instead of rendering as an empty roadmap — see CLAUDE.md on why
