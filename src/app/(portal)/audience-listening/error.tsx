...
/**
 * Catches read failures thrown by lib/audience-listening/queries.ts. A broken
 * query says so, out loud, instead of rendering as an empty query list — see
 * CLAUDE.md on why a swallowed Supabase error is a bug, not a fallback.
 */
export default function AudienceListeningError({
  error,
  reset,
}: {
